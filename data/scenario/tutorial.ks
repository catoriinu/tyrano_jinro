...
[eval exp="f.doneTutorial.instruction = true"]
...
[eval exp="sf.tutorialMode = false"]
...
[eval exp="f.doneTutorial.COPhase = true"]
...
[eval exp="f.doneTutorial.discussionPhase = true"]
...
[eval exp="f.doneTutorial.votePhase = true"]
...
[eval exp="f.doneTutorial.firstDayNightPhase = true"]
...
これで残り人数は三人。[r]
今日を乗り切れば人狼陣営の勝利です。[p]
[eval exp="f.doneTutorial.secondDayDayPhase = true"]

[jump target="endInstruction" cond="f.doneTutorial.statusButton"]
最後に、ステータス画面の説明をしますね。[r]
右上の「ステータス」ボタンを押してください。[p]

[jump target="endInstruction" cond="f.doneTutorial.statusButton"]
[eval exp="f.doneTutorial.thankStatusButton = true"]
右上の「ステータス」ボタンを押してください。[p]
...
[eval exp="f.doneTutorial.forceStatusButton = true"]
...
[if exp="f.doneTutorial.forceStatusButton"]

ふふふ、どうですか？[r]
ここでは私に逆らうことなんてできないんですよーだ！[p]

[elsif exp="f.doneTutorial.thankStatusButton"]
...
[eval exp="f.doneTutorial.statusButton = true"]
...
[eval exp="f.doneTutorial.endInstruction = true"]
