...
*executeCharaNewAndCharaFace
  ...
  [chara_face name="&tf.characterId" face="ワクワク" storage="chara/tsumugi/excited.png"]
  [chara_face name="&tf.characterId" face="ニコニコ" storage="chara/tsumugi/happy.png"]
  [chara_face name="&tf.characterId" face="通常" storage="chara/tsumugi/normal.png"]
  [chara_face name="&tf.characterId" face="ガッカリ" storage="chara/tsumugi/regretful.png"]
  [chara_face name="&tf.characterId" face="悲しみ" storage="chara/tsumugi/sad.png"]
  [chara_face name="&tf.characterId" face="テンアゲ" storage="chara/tsumugi/smug.png"]
  [chara_face name="&tf.characterId" face="苦笑" storage="chara/tsumugi/wrysmile.png"]
  [chara_face name="&tf.characterId" face="敗北" storage="chara/tsumugi/sad.png"]
