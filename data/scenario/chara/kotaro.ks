...
*executeCharaNewAndCharaFace
  [iscript]
    tf.characterId = CHARACTER_ID_KOTARO;
    tf.jname = '白上虎太郎';
  ...
  [chara_new name="&tf.characterId" storage="chara/kotaro/normal.png" width="&f.defaultPosition[tf.characterId].width" haight="&f.defaultPosition[tf.characterId].haight" jname="&tf.jname" reflect="&f.defaultPosition[tf.characterId].reflect"]
