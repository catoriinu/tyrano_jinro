...
*executeCharaNewAndCharaFace
  ...
  [chara_face name="&tf.characterId" face="否定" storage="chara/zundamon/deny.png"]
  [chara_face name="&tf.characterId" face="大喜び" storage="chara/zundamon/happy.png"]
  [chara_face name="&tf.characterId" face="通常" storage="chara/zundamon/normal.png"]
  [chara_face name="&tf.characterId" face="呆れ" storage="chara/zundamon/panicked.png"]
  [chara_face name="&tf.characterId" face="ドヤ顔" storage="chara/zundamon/proud.png"]
  [chara_face name="&tf.characterId" face="悲しみ" storage="chara/zundamon/sad.png"]
  [chara_face name="&tf.characterId" face="自惚れ" storage="chara/zundamon/smug.png"]
  [chara_face name="&tf.characterId" face="驚き" storage="chara/zundamon/surprised.png"]
  [chara_face name="&tf.characterId" face="困惑" storage="chara/zundamon/troubled.png"]
  [chara_face name="&tf.characterId" face="考える" storage="chara/zundamon/thinking.png"]
  [chara_face name="&tf.characterId" face="敗北" storage="chara/zundamon/sad.png"]
