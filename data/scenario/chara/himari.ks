...
*executeCharaNewAndCharaFace
  ...
  [chara_new name="&tf.characterId" storage="chara/himari/normal.png" width="&f.defaultPosition[tf.characterId].width" haight="&f.defaultPosition[tf.characterId].haight" jname="冥鳴ひまり" reflect="true" ]
  [chara_face name="&tf.characterId" face="normal" storage="chara/himari/normal.png"]
