...
*executeCharaNewAndCharaFace
  ...
  [chara_new name="&tf.characterId" storage="chara/mesuo/normal.png" width="&f.defaultPosition[tf.characterId].width" haight="&f.defaultPosition[tf.characterId].haight" jname="&tf.jname" reflect="&f.defaultPosition[tf.characterId].reflect"]
