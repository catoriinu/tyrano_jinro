...
*executeCharaNewAndCharaFace
  ...
  [chara_face name="&tf.characterId" face="ため息" storage="chara/hau/astonished.png"]
  [chara_face name="&tf.characterId" face="笑顔" storage="chara/hau/laughing.png"]
  [chara_face name="&tf.characterId" face="通常" storage="chara/hau/normal.png"]
  [chara_face name="&tf.characterId" face="安心" storage="chara/hau/relieved.png"]
  [chara_face name="&tf.characterId" face="悲しみ" storage="chara/hau/sad.png"]
  [chara_face name="&tf.characterId" face="考える" storage="chara/hau/thinking.png"]
  [chara_face name="&tf.characterId" face="げっそり" storage="chara/hau/tired.png"]
  [chara_face name="&tf.characterId" face="苦笑" storage="chara/hau/wrysmile.png"]
  [chara_face name="&tf.characterId" face="敗北" storage="chara/hau/astonished.png"]
