...
*executeCharaNewAndCharaFace
  ...
  [chara_new name="&tf.characterId" storage="chara/XXX/normal.png" width="&f.defaultPosition[tf.characterId].width" haight="&f.defaultPosition[tf.characterId].haight" jname="XXX" reflect="true" ]
  [chara_face name="&tf.characterId" face="normal" storage="chara/XXX/normal.png"]
