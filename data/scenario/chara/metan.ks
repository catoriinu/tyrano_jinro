...
*executeCharaNewAndCharaFace
  ...
  [chara_face name="&tf.characterId" face="目閉じ" storage="chara/metan/blank.png"]
  [chara_face name="&tf.characterId" face="恥ずかしい" storage="chara/metan/embarrassed.png"]
  [chara_face name="&tf.characterId" face="通常" storage="chara/metan/normal.png"]
  [chara_face name="&tf.characterId" face="困惑" storage="chara/metan/panicked.png"]
  [chara_face name="&tf.characterId" face="悲しみ" storage="chara/metan/sad.png"]
  [chara_face name="&tf.characterId" face="真剣" storage="chara/metan/serious.png"]
  [chara_face name="&tf.characterId" face="クスクス" storage="chara/metan/smug.png"]
  [chara_face name="&tf.characterId" face="大喜び" storage="chara/metan/happy.png"]
  [chara_face name="&tf.characterId" face="敗北" storage="chara/metan/sad.png"]
